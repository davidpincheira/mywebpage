            ...
            <header className="py-12 border-blue-500 border-solid border-t-8">
                <div className="max-w-6xl mx-auto">
                    <div className="ml-6 xl:ml-0">
                        ...
                        <h2 className="capitalize md:text-5xl text-3xl font-bold">{pageData.title}</h2>
            ...
            <ul>
                {
                    pageData.items.map((item,index)=>(
                        ...
                        <li key={index} className="bg-white shadow mt-3 flex max-w-5xl mx-auto">
                            ...
                            <div className="flex items-center flex-1 md:p-8 sm:p-3">
                                <div className="flex-1">
                                <h3 className="md:text-xl sm:text-lg font-bold md:p-1 sm:pl-4 mb-2">{item.name}</h3>
                                {
                                ...
                                {
                                    item.date_start && <span className="inline-block p-2 mt-12 text-2xl bg-gray-300 text-blue-800 font-bold rounded-lg">{item.date_start}- {item.date_end}</span>
                                }
                                {
